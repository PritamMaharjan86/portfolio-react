    ...
    return (
        <div className="App">
                ...
                <div className='title'>
                    ...
                    <p style={{ fontSize: '20px', color: 'black', fontFamily: 'textFont', width: '60%' , fontWeight:'bold'}}> I am passionate about creating experiences that are easy to use, accessible, and that meet the user's needs.</p>
                    {loading ? <Loader /> : <p></p>}
